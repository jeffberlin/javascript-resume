var bio = {
  ...
  "skills" : ["HTML / HTML5", "CSS: Responsive Design, Bootstrap, Foundation, Flexbox", "JavaScript: JQuery, AJAX, KnockoutJS, Angular, ReactJS, JSON, Webpack, Jasmine Testing", "Python", "WordPress", "PHP", "SQL / Postgres", "Git / GitHub", "Slack", "Adobe Creative Cloud: Photoshop, Illustrator, InDesign, Bridge, Dreamweaver", "Sketch"],
